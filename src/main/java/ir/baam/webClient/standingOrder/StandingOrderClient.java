...
public interface StandingOrderClient {
  ...
  @PostMapping(value = "/standing-order/runningScheduler/payment/initiate",consumes = MediaType.APPLICATION_JSON_VALUE)
  ...
  @PostMapping(value = "/standing-order/runningScheduler/payment/execution",consumes = MediaType.APPLICATION_JSON_VALUE)
