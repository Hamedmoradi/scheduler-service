...
import scheduler.service.exeption.BusinessException;
import scheduler.service.exeption.JobNotFoundException;
                    ...
                    .writeWith(Mono.fromSupplier(() -> {
                        ...
                        try {
                            return bufferFactory.wrap(objectMapper.writeValueAsBytes(
                                    new ErrorDto("The required values are either not entered, or are not correct.",
                                            400,
